...
export default function Menu({ navigation }) {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      screen: 'Duyurular',
      description: 'Okul duyurularını takip et'
    },
    {
      title: 'Öğretmenlerim',
      icon: 'people-outline',
    ...
    },
    {
      ...
      subItems: [
        {
          id: 'ogretmen-duyurular',
          title: 'Duyurular',
          screen: 'OgretmenDuyurular',
        },
        {
          id: 'ogretmen-sinav-yonetimi',
          title: 'Sınav Yönetimi',
          screen: 'OgretmenSinavYonetimi',
        },
      ],
    },
  ];
  ...
  const handleMenuPress = (screen) => {
    if (screen === 'OgretmenSinavYonetimi') {
      navigation.navigate('OgretmenSinavYonetimi');
    } else {
